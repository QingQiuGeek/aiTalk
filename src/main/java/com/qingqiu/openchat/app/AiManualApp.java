package com.qingqiu.openchat.app;
...
import com.qingqiu.openchat.factory.QwenChatModelFactory;
import com.qingqiu.openchat.domain.dto.UserMessageDTO;
import com.qingqiu.openchat.service.AiManualService;
import com.qingqiu.openchat.tools.ImageGenerateTextTool;
import com.qingqiu.openchat.tools.TextGenerateImageTool;
...
public class AiManualApp {
    ...
    @Resource
    QwenChatModelFactory qwenChatModelFactory;
  ...
  public String chatStr(UserMessageDTO userMessage) {
    ...
    public Flux<ServerSentEvent<String>> chatTokenStream(UserMessageDTO userMessage) {
      QwenStreamingChatModel qwenStreamingChatModel = qwenChatModelFactory.createQwenStreamingChatModel(
