...
import com.qingqiu.openchat.constant.Common;
...
public class FileUtil {
  ...
  public static void checkImageType(String fileName) {
    ...
    if (fileName == null || fileName.isEmpty()) {
      throw new BizException(BizExceptionEnum.IMAGE_TYPE_ERROR.getCode(), BizExceptionEnum.IMAGE_TYPE_ERROR.getMessage());
    }
    //获取文件后缀
  ...
  public static boolean checkOrCreateDirectory(String path) {
    ...
    if (directory.exists() && directory.isDirectory()) {
      ...
      throw new BizException(BizExceptionEnum.SYSTEM_ERROR.getCode(), BizExceptionEnum.SYSTEM_ERROR.getMessage());
