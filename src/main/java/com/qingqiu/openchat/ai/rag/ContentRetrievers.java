...
import static com.qingqiu.openchat.util.SearXNGUtil.getSearXNGParams;

import com.qingqiu.openchat.config.RagConfig;
import com.qingqiu.openchat.config.SearXNGConfig;
...
//  DocumentSplitter documentSplitter;
  ...
  /*
  * 基于 pgVectorEmbeddingStore的 ContentRetriever
  * */
  @Bean
...
//  @Bean
  ...
  /*
  * 基于联网搜索的 ContentRetriever （模型本身可以就启用联网搜索）
  * */
//  @Bean
