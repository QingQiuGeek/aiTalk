package com.qingqiu.openchat.ai.chatMemoryProvider;

import com.qingqiu.openchat.ai.chatMemoryProvider.chatMemoryStore.FileMemoryStore;
import com.qingqiu.openchat.ai.chatMemoryProvider.chatMemoryStore.PostgreMemoryStore;
import com.qingqiu.openchat.ai.chatMemoryProvider.chatMemoryStore.RedisMemoryStore;
...
public class ChatMemoryProvider {
  ...
  * */
   ...
   * */
  @Bean
  dev.langchain4j.memory.chat.ChatMemoryProvider postgresqlStoreChatMemoryProvider(){
    return sessionId -> MessageWindowChatMemory.builder().chatMemoryStore(new PostgreMemoryStore()).maxMessages(maxMessages).id(sessionId).build();
  }
