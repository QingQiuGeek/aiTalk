package com.qingqiu.openchat.ai.model;
...
import com.qingqiu.openchat.config.QwenModelConfig;
...
public class QwenChatModel {
  ...
  /*
  * 普通文本模型 chatModel
  * 固定写死 enableThinking 和 enableSearch，配置给 AiAutoService
  * */
  @Bean
  public dev.langchain4j.community.model.dashscope.QwenChatModel textQwenChatModel() {
