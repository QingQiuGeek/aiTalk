...
import com.qingqiu.openchat.convert.DocumentConverter;
import com.qingqiu.openchat.exception.BizException;
import com.qingqiu.openchat.mapper.ChunkBgeM3Mapper;
import com.qingqiu.openchat.mapper.DocumentMapper;
import com.qingqiu.openchat.domain.dto.DocumentDTO;
...
import com.qingqiu.openchat.service.DocumentService;
import com.qingqiu.openchat.service.DocumentStorageService;
import com.qingqiu.openchat.service.MarkdownParserService;
...
public class DocumentServiceImpl implements DocumentService {
    ...
    public Long uploadDocument(String kbId, MultipartFile file) {
        try {
            ...
            // 保存文件
            String filePath = documentStorageService.saveFile(kbId, documentId.toString(), file);
            ...
            // 如果是 Markdown 文件，进行解析并生成 chunks（向量化处理）
            if ("md".equalsIgnoreCase(filetype) || "markdown".equalsIgnoreCase(filetype)) {
                processMarkdownDocument(kbId, documentId.toString(), filePath);
            } else {
    ...
    /**
     * 处理 Markdown 文档，解析并生成 chunks，向量化处理
     */
